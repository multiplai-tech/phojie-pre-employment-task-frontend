...
export default {
  ...
  shortcuts: [
    ...
    [/^nav-link-active-text(-(\S+))?$/, ([, , c = 'primary']) => `bg-gray-200/80 dark:bg-gray-900/80 font-medium text-${c}-600 dark:text-${c}-500`],
    [/^nav-link-inactive-text(-(\S+))?$/, ([, , c = 'primary']) => `text-${c}-600 dark:text-${c}-300`],
    [/^nav-link-text(-(\S+))?$/, ([, , c = 'primary']) => `hover:bg-gray-200/80 hover:dark:bg-gray-900/80 hover:text-${c}-600 dark:hover:text-${c}-500`],
